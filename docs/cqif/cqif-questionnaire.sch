...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Questionnaire/f:item">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/cqif-basic-condition']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/cqif-basic-condition': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/cqif-basic-initialValue']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/cqif-basic-initialValue': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/cqif-basic-calculatedValue']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/cqif-basic-calculatedValue': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
